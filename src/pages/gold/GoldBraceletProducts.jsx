  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const response = await fetch(`${baseUrl}/api/product/gold-bracelet`);
        if (!response.ok) {
  ...
  return (
    <div className="flex flex-col pt-10 border-t">
      <div className="flex justify-between text-base sm:text-2xl mb-4 px-4">
        <Title text1="GOLD" text2="BRACELETS" />
      </div>
...
export default GoldBraceletProducts;
