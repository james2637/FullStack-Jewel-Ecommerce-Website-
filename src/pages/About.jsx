    ...
    <div>
      ...
      <div className="my-10 px-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4">
          ...
          <b>Our Promise</b>
          <p>At RG Golds, we believe that everyone deserves to shine. We are dedicated to offering genuine jewellery at prices that are fair and accessible, without compromising on quality. Our transparent pricing and customer-first approach have earned us the loyalty of clients across Kolkata and beyond.</p>
        </div>
      </div>
      <div className="text-xl py-4 px-10">
        <Title text1={'WHY'} text2={'RG GOLDS?'}/>
      </div>
